...
# should be separated by a “. ” (dot and space). Words that should not be included
# in the acronym are stored in the list stopwords. For example, 
# if sent was assigned the string “height and ewok wonder” 
